...
total_cases_north_of_equator

# Filter for Australia cases
total_australia_cases <- confirmed %>% filter(`Country/Region` == 'Australia') %>% select(`3/22/20`) %>% sum()
total_australia_cases
# Display percentages
total_cases_north_of_equator / total_cases * 100
total_australia_cases / total_cases * 100
```
...
max_confirmed <- countries_confirmed %>% filter(`Country/Region` == 'US') %>% select(-`Country/Region`) %>% max()
max_recovered <- countries_recovered %>% filter(`Country/Region` == 'US') %>% select(-`Country/Region`) %>% max()
